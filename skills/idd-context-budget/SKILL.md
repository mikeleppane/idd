---
name: idd-context-budget
description: Refuse subagent dispatches that lack a context_budget block, or whose budget is unbounded. Use whenever you are about to spawn an Agent subagent during /idd:execute, /idd:verify, or any IDD review. Pairs with the hooks/check_budget.py PreToolUse hook, which performs the mechanical deny.
---

# IDD Context Budget Enforcement
